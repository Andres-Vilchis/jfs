...
<div class="toast-container position-fixed bottom-0 end-0 p-3" style="z-index: 1100;">
    <div id="contactoToast" class="toast align-items-center border-0 shadow"
        ...
        <div class="toast-body d-flex flex-column gap-2 pb-3">
                                    ...
                                    <div class="fw-semibold d-flex align-items-center gap-1">
                                        <button type="button"
                                            ...
                                            onclick="abrirContacto(
                                                '<?= esc(addslashes($nombreCompleto), 'js') ?>',
                                                '<?= esc(addslashes($correo),         'js') ?>',
                                                '<?= esc(addslashes($telefono),       'js') ?>'
                                            )">
...
<script>
function abrirContacto(nombre, correo, telefono) {
