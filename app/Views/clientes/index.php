                        ...
                        <?php foreach ($clientes as $c): ?>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <?php if ($c['telefono']): ?>
                                        <span style="max-width:140px !important" class="badge d-flex align-items-center p-1 pe-2 text-dark-emphasis bg-light-subtle border border-dark-subtle rounded-pill"> <i class="bi bi-telephone-outbound-fill me-1"></i>
